...
@Component
public class GraphQLTrackProvider {
    ...
    public void init() throws IOException {
        try (InputStream schema = getClass().getClassLoader().getResourceAsStream(
            "schema.graphql")) {
            if (schema == null) {
            ...
            this.graphQL = GraphQL.newGraphQL(graphQLSchema)
                //.instrumentation(new TracingInstrumentation())  //retrieve some information about graphql query
                .build();
        }
    }
